...
This [literate configuration](https://blog.lhotka.name/posts/literate-ha-config)
describes my Home Assistant implementation
...
three phases. See also my [[https://blog.lhotka.name/posts/adaptive-bev-charging][blog post]].
